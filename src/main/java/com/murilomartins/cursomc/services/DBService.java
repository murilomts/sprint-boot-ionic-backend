package com.murilomartins.cursomc.services;
...
import com.murilomartins.cursomc.domain.enums.Perfil;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria.silva@gmail.com", "08644909625", TipoCliente.PESSOAFISICA, pe.encode("senha234"));
		cli1.getTelefones().addAll(Arrays.asList("32325588", "955446633"));

		Cliente cli2 = new Cliente(null, "Ana Costa Silva", "ana.silva@gmail.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("senha234"));
		cli1.getTelefones().addAll(Arrays.asList("32174499", "988441122"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Larga Porai", "222", null, "Aparecida", "38413555", cli2, c2);
